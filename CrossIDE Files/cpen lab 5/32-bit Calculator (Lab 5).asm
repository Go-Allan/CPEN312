...
forever:
 	...
 	jb KEY.3, no_add    ; If '+' key not pressed, go to no_add
 	jnb KEY.0, is_mult	; if if 0 key pressed check for multiplication 
 	mov operation, #000_0001B
 	jnb KEY.3, $        ; Wait for user to release '+' key ($ is like loop)
 	ljmp clear
 	ljmp forever
...
no_add:  
 	jb KEY.2, no_sub  ; If '=' key not pressed, skip  
 	jnb KEY.0, is_div        ; Wait for user to release '=' key  
